...
AmCharts.Class = function(a) {
    ...
    a.inherits ? (b.prototype = new a.inherits(AmCharts.inheriting), b.base = a.inherits.prototype, delete a.inherits) : (b.prototype.createEvents = function() { for (var a = 0, b = arguments.length; a < b; a++)this.events[arguments[a]] = [] }, b.prototype.listenTo = function(a, b, c) {
    ...
    }, b.prototype.removeListener = function(a, b, c) { if (a && a.events)for (a = a.events[b], b = a.length - 1; 0 <= b; b--)a[b].handler === c && a.splice(b, 1) }, b.prototype.fire = function(a, b) {
...
AmCharts.addInitHandler = function(a, b) { AmCharts.initHandlers.push({ method: a, types: b }) };
...
AmCharts.makeChart = function(a, b, c) {
    ...
    AmCharts.extend(e,
        b);
    AmCharts.isReady ? isNaN(c) ? e.write(a) : setTimeout(function() { AmCharts.realWrite(e, a) }, c) : AmCharts.ready(function() { isNaN(c) ? e.write(a) : setTimeout(function() { AmCharts.realWrite(e, a) }, c) });
    return e;
};
...
AmCharts.deleteObject = function(a, b) {
    if (a) {
        ...
        if (0 !== b)
            if ("[object Array]" === Object.prototype.toString.call(a))for (var c = 0; c < a.length; c++)AmCharts.deleteObject(a[c], b - 1), a[c] = null;
            else if (a && !a.tagName)
                try {
...
AmCharts.bounce = function(a, b, c, d, f) { return(b /= f) < 1 / 2.75 ? 7.5625 * d * b * b + c : b < 2 / 2.75 ? d * (7.5625 * (b -= 1.5 / 2.75) * b + .75) + c : b < 2.5 / 2.75 ? d * (7.5625 * (b -= 2.25 / 2.75) * b + .9375) + c : d * (7.5625 * (b -= 2.625 / 2.75) * b + .984375) + c };
...
AmCharts.AmChart = AmCharts.Class({
    construct: function(a) {
        ...
        this.prefixesOfSmallNumbers = [
            { number: 1E-24, prefix: "y" }, { number: 1E-21, prefix: "z" }, { number: 1E-18, prefix: "a" }, { number: 1E-15, prefix: "f" }, { number: 1E-12, prefix: "p" }, { number: 1E-9, prefix: "n" },
    ...
    write: function(a) {
        if (a = "object" != typeof a ? document.getElementById(a) : a) {
            ...
            if (d)
                if (d = this.addLegend(d, d.divId), d.enabled)
                    switch (d.position) {
                    case "bottom":
                        h.appendChild(b);
                        h.appendChild(c);
    ...
    drawLabel: function(a) {
        if (this.container && !1 !== a.enabled) {
            ...
            0 !== g && c.rotate(g);
            a.url ? (c.setAttr("cursor", "pointer"), c.click(function() { AmCharts.getURL(a.url) })) : c.node.style.pointerEvents = "none";
            this.labelsSet.push(c);
            this.labels.push(c);
        }
    },
    addLabel: function(a, b, c, d, f, e, g, h, k, l) {
        a = { x: a, y: b, text: c, align: d, size: f, color: e, alpha: h, rotation: g, bold: k, url: l, enabled: !0 };
    ...
    addTitle: function(a, b, c, d, f) {
        ...
        a =
        { text: a, size: b, color: c, alpha: d, bold: f, enabled: !0 };
        this.titles.push(a);
        return a;
    },
    ...
    addListeners: function() {
        ...
        }, !0), b.addEventListener("mouseover", function(b) { a.handleMouseOver.call(a, b) }, !0), b.addEventListener("mouseout", function(b) { a.handleMouseOut.call(a, b) }, !0)) : (b.attachEvent("onmousedown", function(b) {
            a.handleMouseDown.call(a,
                b);
        }), b.attachEvent("onmouseover", function(b) { a.handleMouseOver.call(a, b) }), b.attachEvent("onmouseout", function(b) { a.handleMouseOut.call(a, b) }));
    },
    dispDUpd: function() {
        if (!this.skipEvents) {
            var a;
    ...
    showBalloon: function(a, b, c, d, f) {
        ...
        e.balloonTO = setTimeout(function() { e.showBalloonReal.call(e, a, b, c, d, f) }, 1);
    },
...
AmCharts.AmBalloon = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor, n = this.fillColor, t = this.borderColor, p = n;
                void 0 != m && (this.adjustBorderColor ? p = t = m : n = m);
                var z = this.horizontalPadding, y = this.verticalPadding, v = this.pointerWidth, B = this.pointerOrientation, A = this.cornerRadius, w = c.fontFamily, r = this.fontSize;
                void 0 == r && (r = c.fontSize);
                var m = document.createElement("div"), u = c.classNamePrefix;
                ...
                q < g && (q = g);
                q + x > k && (q = k - x);
                var h = r + y, l = q + z, y = this.shadowAlpha, F = this.shadowColor, z = this.borderThickness, D = this.bulletSize, E;
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (e.translate(this.prevX, this.prevY), e.animate({ translate: q - f + "," + r },
                    b, "easeOutSine"), m && (u.left = this.prevTX + "px", u.top = this.prevTY + "px", this.xAnim = c.animate({ node: m }, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({ node: m }, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = q - f;
                this.prevY = r;
                this.prevTX = l;
                this.prevTY = h;
    ...
    followCursor: function(a) {
        ...
        !isNaN(c) && a && (b.pointToX = c - b.offsetX * b.deltaSignX, b.pointToY = d, b.followMouse(), b.interval = setInterval(function() { b.followMouse.call(b) },
            40));
    },
    removeDiv: function() {
        if (this.textDiv) {
...
AmCharts.bullet = function(a, b, c, d, f, e, g, h, k, l, m) {
    ...
    case "yError":
        ...
        break;
    case "xError":
        n = a.set(), n.push(AmCharts.line(a, [
            -c /
            2, c / 2
...
AmCharts.makeHD = function(a, b, c) {
    for (var d = [], f = [], e = 1; e < a.length; e++)
        for (var g = Number(a[e - 1]), h = Number(b[e - 1]), k = Number(a[e]), l = Number(b[e]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, n = 0; n <= m; n++) {
            var t = g + n * k + Math.random() * c, p = h + n * l + Math.random() * c;
            d.push(t);
            f.push(p);
        }
    return[d, f];
...
AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
    ...
    g = t(g);
    h = t(h);
    var p = t(g / e * h), z = AmCharts.VML, y = 359.5 + e / 100;
    359.94 < y && (y = 359.94);
    f >= y && (f = y);
    var v = 1 / 180 * Math.PI, y = b + Math.sin(d * v) * h, B = c - Math.cos(d * v) * p, A = b + Math.sin(d * v) * e, w = c - Math.cos(d * v) * g, r = b + Math.sin((d + f) * v) * e, u = c - Math.cos((d + f) * v) * g, q = b + Math.sin((d + f) * v) * h, v = c - Math.cos((d + f) * v) * p, x = { fill: AmCharts.adjustLuminosity(l.fill, -.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"] }, C = 0;
    180 < Math.abs(f) && (C = 1);
    d = a.set();
    var F;
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = 0;
        if (f = this.title)
            f = AmCharts.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, f, "legend-title"),
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            var k = this.container, l = this.markerSize, m = 0, n = 0, t = l / 2;
            if (this.useGraphSettings) {
                c = a.type;
                this.switchType = void 0;
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                    g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m =
                ...
                h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l,
    ...
    addListeners: function(a, b) {
        var c = this;
        a && a.mouseover(function(a) { c.rollOverMarker(b, a) }).mouseout(function(a) { c.rollOutMarker(b, a) }).click(function(a) {
            c.clickMarker(b,
                a);
        });
    },
    ...
    createValue: function(a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (b.valueText && 0 < b.valueWidth) {
                ...
                var h = b.valueText, f = f + b.lx + b.markerLabelGap + b.valueWidth, k = "end";
            ...
            c = b.container.rect(a.legendEntryWidth, 0, e, d, 0, 0).attr({ stroke: "none", fill: "#fff", "fill-opacity": .005 });
            c.dItem = a;
            b.entries[b.index -
                1].push(c);
...
AmCharts.AmMap = AmCharts.Class({
    ...
    handleMouseMove: function(a) {
        ...
        if (a = b.mapContainer) {
            ...
            var l = b.realHeight, m = b.realWidth, n = b.mapWidth, t = b.mapHeight;
            if (!isNaN(h)) {
                b.stopDrag();
                var h = Math.sqrt(Math.pow(h - f, 2) + Math.pow(k - e, 2)), p = b.previousDistance, k = Math.max(b.realWidth, b.realHeight);
                ...
                if (!isNaN(p)) {
                    var z = 5 * Math.abs(p - h) / k,
                        ...
                        p = (b.zoomY() - p * z) * (k / g) + p * z;
                    .1 < Math.abs(k - g) && (b.zoomTo(k, y, p, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO));
                }
    ...
    selectObject: function(a) {
        ...
        c = b.zoomDuration;
        !f && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY) ? (b.showDescriptionAndGetUrl(), b.processObjects()) : (b.selectedObjectTimeOut = setTimeout(function() { b.showDescriptionAndGetUrl.call(b) }, 1E3 * c + 200), b.showObjectsAfterZoom ?
    ...
    formatString: function(a,
        ...
        var g = b.customData;
        void 0 == g && (g = "");
        return a = AmCharts.massReplace(a, { "[[title]]": f, "[[value]]": e, "[[percent]]": c, "[[description]]": d, "[[customData]]": g });
    },
            ...
            for (f = 0; f < h; f++) {
                ...
                if (0 !== e.childNodes.length || "" !== l || !1 !== m)
                    if (3 == e.nodeType || 4 == e.nodeType) {
                        ...
                        if (e.attributes &&
                            e.attributes.length)for (l = 0; l < e.attributes.length; l++)n[e.attributes[l].name] = e.attributes[l].value;
...
AmCharts.ZoomControl = AmCharts.Class({
    ...
    init: function(a, b) {
        ...
        if (e) {
            ...
            r.translate(-3,
                -3);
            r.mouseup(function() { c.handleBgUp() }).touchend(function() { c.handleBgUp() });
            u.push(r);
...
AmCharts.SimpleButton = AmCharts.Class({
    ...
    init: function(a, b, c, d, f, e, g, h, k, l, m) {
        ...
        l.push(d);
        if (f = n.iconPath)e = n.iconSize, a = a.image(f, (b - e) / 2, (c - e) / 2, e, e), l.push(a), a.setAttr("opacity", m), a.mousedown(function() { n.handleDown() }).mouseup(function() { n.handleUp() }).mouseover(function() { n.handleOver() }).mouseout(function() { n.handleOut() });
        d.mousedown(function() { n.handleDown() }).touchstart(function() { n.handleDown() }).mouseup(function() { n.handleUp() }).touchend(function() { n.handleUp() }).mouseover(function() { n.handleOver() }).mouseout(function() { n.handleOut() });
        n.bg = d;
    },
...
AmCharts.AreasProcessor = AmCharts.Class({
    ...
    process: function(a) {
        ...
        this.allObjects = [];
        a = a.areas;
        var b = this.chart, c, d = a.length, f, e, g = 0, h = b.svgAreasById, k = !1, l = !1, m = 0;
        for (f = 0; f < d; f++) {
            e = a[f];
            e = e.value;
            if (!1 === k || k < e)k = e;
        ...
        b.minValueReal = l;
        for (f = 0; f < d; f++)
            e = a[f], isNaN(e.value) ? e.percents = void 0 : (e.percents = (e.value - l) /
        ...
        for (f = 0; f < d; f++) {
            ...
            var t = c.color, p = c.alpha, z = c.outlineThickness, y = c.rollOverColor, v = c.selectedColor, B = c.rollOverAlpha, A = c.outlineColor, w = c.outlineAlpha, r = c.balloonText, u = c.selectable, q = c.pattern, x = c.rollOverOutlineColor, C = c.bringForwardOnHover, F = c.preserveOriginalAttributes;
...
AmCharts.ImagesProcessor = AmCharts.Class({
    ...
    createImage: function(a, b) {
        ...
        if (u) {
            ...
            r ? (isNaN(p) && (p = 10), isNaN(v) && (v = 10), C = d.image(r, 0, 0, p, v), C.node.setAttribute("preserveAspectRatio", "none"), C.setAttr("opacity", h), a.centeredReal && (y = isNaN(a.right) ? -p / 2 : p / 2, l = isNaN(a.bottom) ? -v / 2 : v / 2, C.translate(y, l))) : B && (C =
    ...
    createPredefinedImage: function(a, b, c, d, f, e) {
        ...
        case "circle":
            ...
            break;
        case "rectangle":
            h = AmCharts.polygon(g,
            [-f / 2, f / 2, f / 2, -f / 2], [e / 2, e / 2, -e / 2, -e / 2], a, 1, c, b, 1);
            break;
        case "bubble":
        ...
        for (u = 0; u < b.length; u++) {
            ...
            if (q.remainVisible || c.selectedObject == q.parentObject) {
                ...
                if (0 < G.length) {
                    ...
                    q.fixedSize && K && (this.linesToResize.push({ line: K, thickness: C }), this.linesToResize.push({ line: F, thickness: 3 }));
                    q.lineSvg = K;
...
AmCharts.DescriptionWindow = AmCharts.Class({
    ...
    show: function(a, b, c, d) {
        ...
        h.onclick = function() { f.close() };
        h.onmouseover = function() {
            h.src = a.pathToImages +
                "xIconH.gif";
        };
        h.onmouseout = function() { h.src = a.pathToImages + "xIcon.gif" };
        e.appendChild(h);
        b = document.createElement("div");
...
AmCharts.ValueLegend = AmCharts.Class({
    ...
    init: function(a, b) {
        if (this.enabled) {
            ...
            AmCharts.setCN(a,
                e, "value-legend");
            var g = 0, h = this.minValue, k = this.fontSize, l = a.fontFamily, m = this.color;
