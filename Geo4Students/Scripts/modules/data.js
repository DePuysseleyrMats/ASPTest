...
*/
(function(g) {
    var k = g.each, t = g.pick, r = HighchartsAdapter.inArray, u = g.splat, j, p = function(b, a) { this.init(b, a) };
    g.extend(p.prototype, {
        ...
        getColumnDistribution: function() {
            var b =
                ...
                n = 0,
                i;
            k(b && b.series || [], function(b) { c.push(f(b.type || d)) });
            k(a && a.seriesMapping || [], function(b) { e.push(b.x || 0) });
            e.length === 0 && e.push(0);
        ...
        parseCSV: function() {
            ...
            e && (g = e.replace(/\r\n/g, "\n").replace(/\r/g, "\n").split(a.lineDelimiter || "\n"), i = a.itemDelimiter || (e.indexOf("\t") !== -1 ? "\t" : ","), k(g, function(a, e) {
                ...
                e >= d && e <= c && !v && g !== "" && (g = a.split(i), k(g, function(b, a) { a >= h && a <= n && (f[a - h] || (f[a - h] = []), f[a - h][s] = b) }), s += 1);
            }), this.dataFound());
        },
        parseTable: function() {
            var b = this.options,
            ...
            a && (typeof a === "string" && (a = document.getElementById(a)), k(a.getElementsByTagName("tr"), function(b, a) { a >= f && a <= d && k(b.children, function(b, d) { if ((b.tagName === "TD" || b.tagName === "TH") && d >= c && d <= h)e[d - c] || (e[d - c] = []), e[d - c][a - f] = b.innerHTML }) }), this.dataFound());
        },
        ...
        parseTypes: function() { for (var b = this.columns, a = b.length; a--;)this.parseColumn(b[a], a) },
    ...
    g.Data = p;
    g.data = function(b, a) { return new p(b, a) };
        ...
        a && a.data ? g.data(g.extend(a.data, {
            afterComplete: function(d) {
                ...
                if (a.hasOwnProperty("series"))
                    if (typeof a.series === "object")for (c = Math.max(a.series.length, d.series.length); c--;)h = a.series[c] || {}, a.series[c] = g.merge(h, d.series[c]);
    ...
    j.prototype.populateColumns = function(b) {
        var a = !0;
        k(this.readers, function(a) { if (a.columnIndex === void 0)a.columnIndex = b.shift() });
        k(this.readers, function(b) { b.columnIndex === void 0 && (a = !1) });
        return a;
    };
