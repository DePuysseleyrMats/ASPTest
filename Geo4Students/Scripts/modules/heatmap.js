...
(function(h) {
    ...
    s(q.prototype, {
        ...
        init: function(a, b) {
            ...
            c = m(this.defaultColorAxisOptions, { side: e ? 2 : 1, reversed: !e }, b, { isX: e, opposite: !e, showEmpty: !1, title: null, isColor: !0 });
        ...
        tweenColors: function(a, b, e) {
            var c;
            !b.rgba.length || !a.rgba.length ? (h.error(23), a = b.raw) : (a = a.rgba, b = b.rgba, c = b[3] !== 1 || a[3] !== 1, a = (c ?
                "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - e)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - e)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - e)) + (c ? "," + (b[3] + (a[3] - b[3]) * (1 - e)) : "") + ")");
            return a;
        },
        initDataClasses: function(a) {
            ...
            i(a.dataClasses, function(a, h) {
                ...
                c.push(a);
                if (!a.color)
                    f.dataClassColor === "category" ? (i = e.options.colors, a.color = i[d++], d === i.length && (d = 0)) : a.color = b.tweenColors(k(f.minColor),
                        k(f.maxColor), g < 2 ? 0.5 : h / (g - 1));
            });
        },
        initStops: function(a) {
            this.stops = a.stops || [[0, this.options.minColor], [1, this.options.maxColor]];
            i(this.stops, function(a) { a.color = k(a[1]) });
        },
        ...
        setAxisSize: function() {
            ...
            if (a)
                this.left = e = a.attr("x"), this.top = c = a.attr("y"), this.width = d = a.attr("width"), this.height = a = a.attr("height"), this.right = b.chartWidth -
                    e - d, this.bottom = b.chartHeight - c - a, this.len = this.horiz ? d : a, this.pos = this.horiz ? e : c;
        },
        ...
        getPlotLinePath: function(a, b, e, c, d) {
            return d ? this.horiz ? ["M", d - 4, this.top - 6, "L", d + 4, this.top - 6, d, this.top, "Z"] : [
                "M", this.left, d, "L",
                this.left - 6, d + 6, this.left - 6, d - 6, "Z"
            ] : l.prototype.getPlotLinePath.call(this, a, b, e, c);
        },
        update: function(a, b) {
            i(this.series, function(a) { a.isDirtyData = !0 });
        ...
        getDataClassLegendSymbols: function() {
            ...
            e.length || i(this.dataClasses, function(c, l) {
                ...
                e.push(s({
                    ...
                    setVisible: function() {
                        k = this.visible = !k;
                        i(a.series, function(a) { i(a.points, function(a) { a.dataClass === l && a.setVisible(k) }) });
    ...
    i(["fill", "stroke"], function(a) {
        HighchartsAdapter.addAnimSetter(a, function(b) {
            b.elem.attr(a, q.prototype.tweenColors(k(b.start),
                k(b.end), b.pos));
        });
    });
    ...
    w(x.prototype, "getAllItems", function(a) {
        ...
        e && (e.options.dataClasses ? b = b.concat(e.getDataClassLegendSymbols()) : b.push(e), i(e.series, function(a) { a.options.showInLegend = !1 }));
    ...
    p.heatmap = y(p.scatter, m(r, {
        ...
        translate: function() {
            ...
            this.chart.hasRendered && i(this.points,
                function(a) { a.shapeArgs.fill = a.options.color || a.color });
        },
