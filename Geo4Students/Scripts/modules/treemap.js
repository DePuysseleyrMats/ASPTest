...
*/
(function(f) {
    var i = f.seriesTypes, l = f.merge, t = f.extendClass, u = f.getOptions().plotOptions, v = function() {}, m = f.each, s = f.pick, n = f.Series, q = f.Color;
    u.treemap = l(u.scatter, {
        showInLegend: !1,
        marker: !1,
        borderColor: "#E0E0E0",
        borderWidth: 1,
        dataLabels: { enabled: !0, defer: !1, verticalAlign: "middle", formatter: function() { return this.point.name || this.point.id }, inside: !0 },
        tooltip: { headerFormat: "", pointFormat: "<b>{point.name}</b>: {point.value}</b><br/>" },
    ...
    i.treemap = t(i.scatter, l({
        pointAttrToOptions: { stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "borderDashStyle" },
        pointArrayMap: ["value"],
        ...
        getTree: function() {
            var a = this,
                ...
                d = [],
                e,
                g = function(a) { m(c[a], function(a) { c[""].push(a) }) },
                h = function(b, c, d, e, g, k) {
                    ...
                    c = { id: b, i: c, children: f, childrenTotal: i, val: l, level: d, parent: k, name: q };
        ...
        setPointValues: function() {
            ...
            m(a.points, function(d) {
                ...
                if (d.value > 0)d.shapeType = "rect", d.shapeArgs = { x: Math.min(g, h), y: Math.min(f, e), width: Math.abs(h - g), height: Math.abs(e - f) }, d.plotX = d.shapeArgs.x + d.shapeArgs.width / 2, d.plotY = d.shapeArgs.y + d.shapeArgs.height / 2;
            });
        },
        getSeriesArea: function(a) {
            var b = this.options.layoutStartingDirection === "vertical" ? 0 : 1;
            return{ x: 0, y: 0, width: 100 * (this.axisRatio = this.xAxis.len / this.yAxis.len), height: 100, direction: b, val: a };
        },
        getLevels: function() {
            var a =
                [],
                b = this.options.levels;
            b && m(b, function(b) { b.level !== void 0 && (a[b.level] = b) });
            return a;
        },
        setColorRecursive: function(a, b) {
            ...
            if (a) {
                ...
                if (d)d.color = b;
                a.children.length && m(a.children, function(a) { c.setColorRecursive(a, b) });
            }
        },
        alg_func_group: function(a, b, c, d) {
            ...
            this.lP = {
                ...
                nR: 0,
                lR: 0,
                aspectRatio: function(a, b) { return Math.max(a / b, b / a) }
            };
        ...
        alg_func_calcPoints: function(a, b, c, d) {
            var e, g, h, f, i = c.lW, o = c.lH, j = c.plot, p, k = 0, l = c.elArr.length - 1;
            b ? (i = c.nW, o = c.nH) : p = c.elArr[c.elArr.length - 1];
            m(c.elArr, function(a) {
                if (b || k < l)c.direction === 0 ? (e = j.x, g = j.y, h = i, f = a / h) : (e = j.x, g = j.y, f = o, h = a / f), d.push({ x: e, y: g, width: h, height: f }), c.direction === 0 ? j.y += f : j.x += h;
                k += 1;
            });
            c.reset();
        ...
        alg_func_lowAspectRatio: function(a, b, c) {
            var d = [], e = this, g, h = { x: b.x, y: b.y, parent: b }, f = 0, i = c.length - 1, o = new this.alg_func_group(b.height, b.width, b.direction, h);
            m(c, function(c) {
        ...
        alg_func_fill: function(a, b, c) {
            var d = [], e, g = b.direction, h = b.x, f = b.y, i = b.width, o = b.height, j, l, k, n;
            m(c, function(c) {
        ...
        strip: function(a, b) { return this.alg_func_lowAspectRatio(!1, a, b) },
        squarified: function(a, b) { return this.alg_func_lowAspectRatio(!0, a, b) },
        sliceAndDice: function(a, b) { return this.alg_func_fill(!0, a, b) },
        ...
        drawDataLabels: function() {
            var a = this, b, c, d = this.dataLabelsGroup, e;
            m(a.points, function(d) {
                if (d.node.isVisible)
        ...
        drawPoints: function() {
            var a = this, b = a.points, c = a.options, d, e, g;
            m(b, function(b) {
                if (b.node.isVisible) {
                    g = a.levelMap[b.level];
                    d = { stroke: c.borderColor, "stroke-width": c.borderWidth, dashstyle: c.borderDashStyle, r: 0, fill: s(b.color, a.color) };
                    ...
                    if (!b.isLeaf)s(c.interactByLeaf, !c.allowDrillToNode) ? (d.fill = "none", delete e.fill) : (d.fill = q(d.fill).setOpacity(0.15).get(), e.fill = q(e.fill).setOpacity(0.75).get());
                    if (b.node.level <= a.nodeMap[a.rootNode].level)d.fill = "none", d.zIndex = 0, delete e.fill;
                    b.pointAttr[""] =
                        f.extend(b.pointAttr[""], d);
                    b.dataLabel && b.dataLabel.attr({ zIndex: b.pointAttr[""].zIndex + 1 });
                }
            });
            i.column.prototype.drawPoints.call(this);
            m(b, function(a) { a.graphic && a.graphic.attr(a.pointAttr[""]) });
        ...
        drillTo: function() {
            ...
            m(a.points, function(b) {
                var c, d;
                if (b.node.isVisible && (f.removeEvent(b, "click"), b.graphic && b.graphic.css({ cursor: "default" }), c = a.options.interactByLeaf ? a.drillToByLeaf(b) : a.drillToByGroup(b)))
                    d = a.nodeMap[a.rootNode].name || a.rootNode, b.graphic &&
                        b.graphic.css({ cursor: "pointer" }), f.addEvent(b, "click", function() {
                        b.setState("");
                        a.drillToNode(c);
        ...
        drillToByGroup: function(a) {
            var b = !1;
            if (a.node.level - this.nodeMap[this.rootNode].level === 1 && !a.isLeaf)b = a.id;
            return b;
        },
        drillToByLeaf: function(a) {
            var b = !1;
            if (a.node.parent !== this.rootNode && a.isLeaf)for (a = a.node; !b;)if (a = this.nodeMap[a.parent], a.parent === this.rootNode)b = a.id;
            return b;
        },
        drillUp: function() {
            var a = null;
            this.rootNode && (a = this.nodeMap[this.rootNode], a = a.parent !== null ?
                this.nodeMap[a.parent] : this.nodeMap[""]);
        ...
        showDrillUpButton: function(a) {
            ...
            (e = (d = c.theme) && d.states, this.drillUpButton = this.chart.renderer.button(a, null, null, function() { b.drillUp() }, d, e && e.hover, e && e.select).attr({ align: c.position.align, zIndex: 9 }).add().align(c.position, !1, c.relativeTo || "plotBox"));
        },
        buildKDTree: v,
