...
//#endregion Class CanvasJSObject
    ...
    Chart.prototype._initialize = function() {
        /// <signature>
        ///     <summary>
        ///         Initializes Chart objects/state. Creates DataSeries class instance for each DataSeries provided by ther
        ///         user. Sets the Axis Type based on the user data
        ///     </summary>
        /// </signature>
    ...
    Chart._supportedChartTypes = [
        "line", "stepLine", "spline", "column", "area", "stepArea", "splineArea", "bar", "bubble", "scatter",
    ...
    Chart.prototype.getPixelCoordinatesOnPlotArea = function(x, y) {
        return { x: this.axisX.getPixelCoordinatesOnAxis(x).x, y: this.axisY.getPixelCoordinatesOnAxis(y).y }; //return { x: 5, y: 10 };
...
//this.ctx.font = getFontString("", this, null);
    ...
    Axis.prototype.createLabels = function() {
        ...
        if (this.type === "axisX" && this.chart.plotInfo.axisXValueType === "dateTime") {
            endPoint = addToDateTime(new Date(this.maximum), this.interval, this.intervalType); //endPoint = this.maximum;
